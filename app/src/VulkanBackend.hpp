...
private:
    ...
    static void createSurface(Quanta_ImplVulkanH_RenderContext &context)
    {
    ...
    static void pickPhysicalDevice(Quanta_ImplVulkanH_RenderContext &context)
    {
    ...
    static void createLogicalDevice(Quanta_ImplVulkanH_RenderContext &context)
    {
                                ...
                                VkExtent2D &swapChainExtent)
    {
        ...
        context.ImageCount = swapChainSupport.capabilities.minImageCount + 1;
        if (swapChainSupport.capabilities.maxImageCount > 0 && context.ImageCount > swapChainSupport.capabilities.maxImageCount)
        {
            context.ImageCount = swapChainSupport.capabilities.maxImageCount;
        }
        ...
        vkGetSwapchainImagesKHR(g_Device, context.Swapchain, &context.ImageCount, nullptr);
        swapChainImages.resize(context.ImageCount);
        vkGetSwapchainImagesKHR(g_Device, context.Swapchain, &context.ImageCount, swapChainImages.data());
    ...
    static void createRenderPass(Quanta_ImplVulkanH_RenderContext &context, VkFormat &swapChainImageFormat)
    {
    ...
    static void createGraphicsPipeline(Quanta_ImplVulkanH_RenderContext &context)
    {
        ...
        if (vkCreateGraphicsPipelines(g_Device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &context.GraphicsPipeline) != VK_SUCCESS)
        {
    ...
    static void createCommandPool(Quanta_ImplVulkanH_RenderContext &context)
    {
    ...
    static void createCommandBuffers(Quanta_ImplVulkanH_RenderContext &context)
    {
    ...
    static void createSyncObjects(Quanta_ImplVulkanH_RenderContext &context)
    {

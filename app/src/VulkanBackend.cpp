...
VkDescriptorSet VulkanBackend::ImGui_ImplVulkan_AddTexture(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout)
{
    ...
    VkDescriptorSet descriptor_set;
    {
        ...
        VkResult err = vkAllocateDescriptorSets(g_Device, &alloc_info, &descriptor_set);
        check_vk_result(err);
    }

    descriptorSets.push_back(descriptor_set);
    ...
    // Update the Descriptor Set:
    {
        ...
        vkUpdateDescriptorSets(g_Device, 1, write_desc, 0, nullptr);
    }
...
//     stbi_uc *pixels = stbi_load("C:/Users/sethc/coding/cplusplus/graphics/quanta-ray-tracing-engine/app/src/textures/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
// void VulkanBackend::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage &image, VkDeviceMemory &imageMemory)
//{
